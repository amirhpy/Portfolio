...
const projects = [
    ...
    { id: 5, img: form, using: 'Javascript ReactJS HTML5 Axios Formik Yup ReactRouterDom TailwindCss', nameProject: 'Form', desc: 'Validated Form for User Registration, Account Deletion, and User Profile Update', toLink: 'https://form-three-xi.vercel.app/' },
]
